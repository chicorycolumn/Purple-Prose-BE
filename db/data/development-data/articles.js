module.exports = [
  {
    ...
    votes: 50,
    body:
      "Fifty votes please! For this part two of a series on how to get up and running with Systemd and Node.js. This part dives deeper into how to successfully run your app with systemd long-term, and how to set it up in a production environment.",
  ...
  {
    title: "The planet that rains glass",
    topic: "astronomy",
    author: "tickle122",
    body:
      "I was reading an article on the BBC website - can you imagine what it would be like to live on this planet, or to have evolved there? 'The temperature of the planet's atmosphere is a scorching 1,000C, and it rains glass, sideways, in howling 7,000km-per-hour winds.' Just think of the science fiction possibilities that would come with such an extreme and bizarre planet environment. Imagine sitting indoors with a nice cup of cocoa while hearing the glass rain smash down outside. I would say 'Uwaga, moje dzieci - teraz pada szkła! Musicie zosta¢ w domu.'",
    created_at: 1585136087851
  }
];
